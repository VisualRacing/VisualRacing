...
- [Specific Requirements](#3-specific-requirements)
    ...
    - [Functionality - Data Analytics](#32-functionality--data-analytics)
    - [Functionality - User Interface](#33-functionality--user-interface)
...
![use case diagramm.png](/Use%20Case%20Diagram.png "use case diagram")
...
### 3.3 Functionality – User Interface
...
Shows the current settings such as whether the metric or the imperial system should be used and allows the user to change these. The settings will be saved in a file.
...
Under [MIT License](https://github.com/ChristopherKlammt/VisualRacing/blob/master/LICENSE).
