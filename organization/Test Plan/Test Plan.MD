...
We integrated TravisCI and AppVeyor int our GitHub pull request workflow. If a build fails (or a reviewer dismisses the Pull Request), the merging of the Pull Request is blocked.
